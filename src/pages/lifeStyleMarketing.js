...
import { sections } from '../pagesUtils/lifestyle';
...
const lifeStylePage = () => {
  ...
  allContentfulSections(filter: {page: {eq: "lifestyle"}}, sort: {fields: order}) {
    edges {
      node {
        id
        subtitle
  ...
  allContentfulSlider(filter: {page: {eq: "lifestyle"}}) {
    edges {
      node {
        id
        actionTitle
  ...
  allContentfulTabs(filter: {page: {eq: "lifestyle"}}, sort: {fields: order}) {
    nodes {
      tab
      title
      subTitle
  ...
  allContentfulCaseStudies(filter: {page: {eq: "lifestyle"}}, sort: {fields: order}) {
    nodes {
      longDescription{
        longDescription
      }
...
//                                     <h1 class="mb-0 display-2">Lifestyle Marketing</h1>
//                                     <h4 class="mb-15 mb-lg-25">More than just Email</h4>
...
//                                     <img src="images/Bimg2@2x.png" alt="" class="mw-100 main d-lg-inline-block" />
//                                     <div class="sec">
//                                           <img src="images/img13@2x.png" alt="" class="w-100 d-none d-md-block" />
//                                           <img src="images/mob-img13@2x.png" alt="" class="w-100 d-block d-md-none" />
//                                     </div>
//                               </div>
//                         </div>
//                   </div>
...
//                         <h4 class="text-right w-50">Our Lifecycle Marketing Partners</h4>
//                         <div class="serv-logo w-50"><img src="images/klaviyo-partners.png" alt="" class="mw-100" /></div>
//                   </div>
...
//             <div class="bg"></div>
//             <div class="container">
//                   <div class="txt-wrp d-block d-lg-none text-center text-md-left">
//                         <div class="log-img mb-15 mb-md-2 mb-xl-3"><img src="images/brumate.png" alt="" /></div>
//                         <p class="mb-15 mb-md-2 mb-xl-3">Aenean non accumsan ante. Duis et risus accumsan sem tempus porta nec sit amet est. Sed ut euismod quam. Suspendisse potenti. Aliquam fringilla orci tincidunt, ullamcorper erat in, malesuada metus.</p>
//                   </div>
//                   <div class="row">
...
//                               <div class="row">
//                                     <div class="col-12 col-sm-8 col-md-10 col-lg-6 mx-auto">
//                                           <div class="story-img">
//                                                 <img src="images/mob1@2x.png" alt="" class="w-100 mob-img" />
//                                           </div>
//                                     </div>
//                                     <div class="col-12 col-sm-8 col-md-10 col-lg-6 d-none d-lg-block">
//                                           <div class="story-img">
//                                                 <img src="images/mob2@2x.png" alt="" class="w-100 mob-img" />
//                                           </div>
//                                     </div>
//                               </div>
...
//                         <h2 class="mb-0 font-weight-normal">Creative Email Gallery</h2>
//                   </div>
...
//                         <div class="slide-img">
//                               <img src="images/mob3@2x.png" alt="" class="w-100 mob-img" />
//                         </div>
//                         <div class="slide-img">
//                               <img src="images/mob4@2x.png" alt="" class="w-100 mob-img" />
//                         </div>
//                         <div class="slide-img">
//                               <img src="images/mob5@2x.png" alt="" class="w-100 mob-img" />
//                         </div>
//                   </div>
...
//                         <h2 class="mb-1 mb-md-2 font-weight-normal">12th Tribe</h2>
...
//                                     <img src="images/img14@2x.png" alt="" class="mw-100 d-inline-block" />
//                               </div>
//                         </div>
...
//                   </div>
//                   <div class="txt-wrp d-block d-md-none text-center">
//                         <h2 class="mb-1 mb-md-2 font-weight-normal">Static Nails</h2>
//                         <p class="mb-1 mb-md-2 mb-lg-3">Duis vestibulum elit vel neque pharetra vulputate. Quisque scelerisque nisi urna. Duis rutrum non risus in imperdiet. Proin molestie accumsan nulla sit amet mattis. Ut vel tristique neque. Praesent purus eros, aliquet sit amet venenatis in, sodales in odio. Curabitur ac ligula et purus cursus vulputate accumsan sit amet erat. Vestibulum ac mauris ut nisl maximus porta eu a libero. In hac habitasse platea dictumst. Proin augue urna, pretium vel mauris sed, lobortis rutrum libero.</p>
//                   </div>
//                   <div class="row align-items-center">
//                         <div class="col-12 col-md-7 order-md-2 pl-lg-3 pl-xl-5">
//                               <div class="serve-img text-center">
//                                     <img src="images/img15@2x.png" alt="" class="mw-100 d-inline-block" />
//                               </div>
//                         </div>
