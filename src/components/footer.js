                                    ...
                                    <div className="col-12 col-xl-7">
                                          <div className="d-block d-lg-flex justify-xl-content-center mb-3 mb-xl-0">
                                                <div className="link-list mb-15 mb-lg-0 px-xl-15">
                                                      <h6 className="footer-title mb-12 mb-lg-25">Get in Touch <span className="caret"></span></h6>
                                                ...
                                                <div className="link-list mb-15 mb-lg-0 px-xl-15">
                                                      <h6 className="footer-title mb-15 mb-lg-25">Know More <span className="caret"></span></h6>
                                                      <ul className="footer_link">
                                                ...
                                                <div className="link-list mb-15 mb-lg-0 px-xl-15">
                                                      <h6 className="footer-title mb-15 mb-lg-25">Legal <span className="caret"></span></h6>
                                                      <ul className="footer_link">
